...
<div class="db-hero">
    ...
    <div class="db-hero-actions">
        ...
        <a class="db-view-btn primary" href="my_tickets.php" data-i18n="staff_my_tickets_link">
    ...
    <div class="db-panel">
        ...
        <div class="db-panel-body">
            <div class="db-actions-grid" style="grid-template-columns:1fr;margin-bottom:0;">
                <a class="db-action-card db-action-primary" href="my_tickets.php">
                ...
                <a class="db-action-card" href="employees.php">
                    <span class="db-action-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                    </span>

...
function buildPasswordResetEmail(string $fullName, string $resetUrl, int $minutes): string
{
    $name = e($fullName);
    $url = e($resetUrl);
            ...
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid #d3f0f9;border-radius:14px;overflow:hidden;box-shadow:0 10px 28px rgba(15,47,97,0.12);">
                    <tr>
                        <td style="background:#0f2f61;color:#ffffff;padding:22px 24px;">
                            <div style="font-size:13px;font-weight:800;color:#bfdbfe;">ICT Support</div>
                            <div style="font-size:22px;font-weight:800;line-height:1.25;margin-top:4px;">Password Reset Request</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:24px;">
                            <p style="margin:0 0 14px;">Hello ' . $name . ',</p>
                            <p style="margin:0 0 18px;color:#475569;">We received a request to reset the password for your ICT Support account. Click the button below to choose a new password. This link expires in ' . $minutes . ' minutes.</p>
                            <p style="margin:0 0 18px;text-align:center;">
                                <a href="' . $url . '" style="display:inline-block;background:#0f2f61;color:#ffffff;text-decoration:none;padding:13px 26px;border-radius:10px;font-weight:800;font-size:15px;">Reset My Password</a>
                            </p>
                            <p style="margin:0 0 18px;color:#64748b;font-size:13px;">If the button does not work, copy and paste this link into your browser:</p>
                            <p style="margin:0 0 18px;background:#f1f5f9;border:1px solid #e2e8f0;border-radius:8px;padding:10px 12px;color:#0f2f61;font-size:12px;word-break:break-all;">' . $url . '</p>
                            <p style="margin:18px 0 0;color:#64748b;font-size:13px;">If you did not request a password reset, you can safely ignore this email. Your password will not be changed.</p>
                        </td>
                    </tr>
                </table>
            </td>

<?php
$currentAdminPage = preg_replace('/\.php$/', '', basename($_SERVER['PHP_SELF']));
...
$adminModules = [
    ['href' => $appRoot . '/admin/dashboard', 'label' => 'Dashboard', 'i18n' => 'subnav_dashboard', 'icon' => '<rect x="3" y="3" width="7" height="7" rx="1"></rect><rect x="14" y="3" width="7" height="7" rx="1"></rect><rect x="14" y="14" width="7" height="7" rx="1"></rect><rect x="3" y="14" width="7" height="7" rx="1"></rect>'],
    ['href' => $appRoot . '/admin/departments', 'label' => 'Departments', 'i18n' => 'subnav_departments', 'icon' => '<path d="M3 21h18"></path><path d="M5 21V7l7-4 7 4v14"></path><path d="M9 21v-8h6v8"></path>'],
    ['href' => $appRoot . '/admin/users', 'label' => 'Users', 'i18n' => 'subnav_users', 'icon' => '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>'],
    ['href' => $appRoot . '/admin/tickets', 'label' => 'Tickets', 'i18n' => 'subnav_tickets', 'icon' => '<path d="M2 9a3 3 0 0 0 0 6v3a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-3a3 3 0 0 0 0-6V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z"></path><path d="M13 5v2"></path><path d="M13 17v2"></path><path d="M13 11v2"></path>'],
    ['href' => $appRoot . '/admin/reports', 'label' => 'Reports', 'i18n' => 'subnav_reports', 'icon' => '<path d="M3 3v18h18"></path><path d="m7 14 4-4 3 3 5-6"></path>'],
    ['href' => $appRoot . '/admin/approvals', 'label' => 'Approvals', 'i18n' => 'subnav_approvals', 'icon' => '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline>'],
    ['href' => $appRoot . '/admin/settings', 'label' => 'Settings', 'i18n' => 'subnav_settings', 'icon' => '<path d="M12 15.5A3.5 3.5 0 1 0 12 8.5a3.5 3.5 0 0 0 0 7z"></path><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1 1.55V22a2 2 0 1 1-4 0v-.09a1.7 1.7 0 0 0-1-1.55 1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.7 1.7 0 0 0 4.6 15a1.7 1.7 0 0 0-1.55-1H3a2 2 0 1 1 0-4h.05a1.7 1.7 0 0 0 1.55-1 1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.7 1.7 0 0 0 1.87.34H9a1.7 1.7 0 0 0 1-1.55V3a2 2 0 1 1 4 0v.05a1.7 1.7 0 0 0 1 1.55 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87V9c0 .68.4 1.29 1.03 1.55H21a2 2 0 1 1 0 4h-.05A1.7 1.7 0 0 0 19.4 15z"></path>'],
];
?>
<div class="admin-shell">
    <aside class="admin-sidebar" aria-label="Admin navigation">
        <div class="admin-sidebar-head">
            <a href="<?= e($appRoot . '/admin/dashboard') ?>" class="admin-sidebar-brand">
        ...
        <div class="admin-menu-panel" data-admin-menu-panel>
            ...
            <a href="<?= e($appRoot . '/logout') ?>" class="admin-logout" data-i18n="nav_logout">Logout</a>
        </div>
    </aside>
        ...
        <div class="admin-topbar">
            ...
            <div class="admin-topbar-actions">
                <div class="admin-profile-wrap" data-profile-menu>
                    <button type="button" class="admin-profile-icon" aria-label="Profile" aria-haspopup="true" aria-expanded="false" title="<?= e($adminUser['full_name'] ?? 'Administrator') ?>">
                        <svg class="admin-avatar-svg" viewBox="0 0 64 64" width="28" height="28" aria-hidden="true">
                            <defs>
                                <radialGradient id="avh1" cx="35%" cy="30%" r="80%">
                                    <stop offset="0%" stop-color="#e6f6fb"></stop>
                                    <stop offset="100%" stop-color="#94a3b8"></stop>
                                </radialGradient>
                                <linearGradient id="avb1" x1="0" y1="0" x2="1" y2="1">
                                    <stop offset="0%" stop-color="#7bc9e8"></stop>
                                    <stop offset="100%" stop-color="#1d7aa3"></stop>
                                </linearGradient>
                            </defs>
                            <circle cx="32" cy="23" r="13" fill="url(#avh1)" stroke="rgba(15,23,42,0.15)" stroke-width="1.5"></circle>
                            <path d="M9 58c0-13.5 10.5-22 23-22s23 8.5 23 22v6H9z" fill="url(#avb1)"></path>
                        </svg>
                    </button>
                    <div class="admin-profile-menu hidden" role="menu" aria-label="Account menu">
                        <div class="admin-profile-menu-head">
                            <div class="admin-profile-menu-name"><?= e($adminUser['full_name'] ?? 'Administrator') ?></div>
                            <div class="admin-profile-menu-role"><?= e(ucfirst((string) ($adminUser['role'] ?? ''))) ?></div>
                        </div>
                        <a href="<?= e($appRoot . '/admin/settings') ?>" class="admin-profile-menu-item" role="menuitem">
                ...
                <button type="button" class="admin-icon-btn" aria-label="Toggle dark mode" data-theme-toggle>

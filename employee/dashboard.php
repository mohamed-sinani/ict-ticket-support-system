...
<div class="db-hero">
    ...
    <div class="db-hero-actions">
        ...
        <a class="db-view-btn primary" href="<?= $baseUrl ?>report.php" data-i18n="employee_report_issue">
...
<div class="db-activity-row">
    <div class="db-panel">
        <div class="db-panel-header">
            ...
            <a class="db-view-btn" href="my_tickets.php" data-i18n="admin_view_all">
    ...
    <div class="db-panel">
        ...
        <div class="db-panel-body">
            <div class="db-actions-grid" style="grid-template-columns:1fr;margin-bottom:0;">
                <a class="db-action-card db-action-primary" href="<?= $baseUrl ?>report.php">
                ...
                <a class="db-action-card" href="my_tickets.php">
                    <span class="db-action-icon">
                ...
                <a class="db-action-card" href="settings.php">
                    <span class="db-action-icon">
